import {DomainTask, GetTasksResponse, Response} from "./tasksApi.types";
...
export const tasksApi = {
    ...
    createTask(title: string, todolistId: string){
        return axios.post<Response<{ item: DomainTask }>>(`https://social-network.samuraijs.com/api/1.1/todo-lists/${todolistId}/tasks`,
            {title}, {
                headers: {
